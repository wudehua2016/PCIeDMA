...
# of Vivado)
################################################################################
create_clock -name m_axis_aclk_0 -period 10 [get_ports m_axis_aclk_0]
create_clock -name s_axis_aclk_0 -period 10 [get_ports s_axis_aclk_0]
create_clock -name PHYA_rgmii_rxc -period 10 [get_ports PHYA_rgmii_rxc]
