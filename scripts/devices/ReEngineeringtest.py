...
class TestMem:
    ...
    def test_normal(self,addr=TEST_ADDR):
        ...
        while True:
            ...
            print("target_addrs["+str(val)+"]:"+str(old))
            
            phys_addrs.append(old)
            old = old + 8
            addr = addr + 8
            ...
            while True:
                ...
                for addr in phys_addrs:
                    ...
                    try:
                        ...
                        logger.info(f"{count},{val},0x{addr:x},{gpio1_id},0x{old}")
                    except OSError:
                        break
                if(count > 5):
                    break
